	...
	var AppComponent = function (_React$Component) {
	  ...
	  _createClass(AppComponent, [{
	    ...
	    value: function componentWillMount() {
	      _axios2.default.get('http://localhost:5000/get_movies').then(function (response) {
	    ...
	    key: 'renderRow',
	    value: function renderRow(row, key) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'image' },
	          _react2.default.createElement('img', { src: row.cover_image })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'content' },
	    ...
	    value: function render() {
	      var loader = this.state.movies.length ? '' : 'active';
	      var loaderClasses = 'ui ' + loader + ' inverted dimmer';
	  ...
	  return new Promise(function executor(resolve, reject) {
	    try {
	      ...
	      if (typeof config.adapter === 'function') {
	        ...
	        adapter = __webpack_require__(302);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var transformData = __webpack_require__(305);
	var isURLSameOrigin = __webpack_require__(306);
	var btoa = (typeof window !== 'undefined' && window.btoa) || __webpack_require__(307);
